...
export const PedidoCertificadoValidation = validation((getSchema) => ({
...
export const PedidoCertificado = async (
  ...
  try {
    ...
    // Envia a atualização via WebSocket somente quando um novo pedido for criado
