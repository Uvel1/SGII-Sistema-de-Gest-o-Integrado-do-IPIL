...
import { ITurmas } from "../../database/models/turmas.models";
import {turmas_turno} from "@prisma/client";

interface IBodyProps extends Omit<ITurmas, 'id'|'created_at'| 'updated_at'>{}

export const createTurmaValidation = validation((getSchema) => ({
 ...
 export const createTurma = async (req:Request<{},{},IBodyProps>, res:Response ) =>{
