...
export const IdProfInValidation = validation((getSchema) => ({
...
export const getNotasAlunos = async (req: Request<IParams>, res: Response) => {
  const { id } = req.params;
  ...
  n.faltas
    ...
    // Converte BigInt e, para os campos de notas e faltas, caso o valor seja null, define 0
