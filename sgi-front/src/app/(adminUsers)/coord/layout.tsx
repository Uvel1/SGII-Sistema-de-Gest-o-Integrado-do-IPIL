...
import { AppSidebar } from "@/components/SideBar/dashboard/coord";
import { SidebarProvider, SidebarTrigger } from "@/components/ui/sidebar";
import { PerfilCoord } from "@/components/DropDown/perfilCoord";
import { MobileSidebar } from "@/components/SideBar/dashboard/coord/mobile";
...
export default function RootLayout({
  ...
  return (
    <SidebarProvider>
      <AppSidebar userRole={role === "coord" ? "coord" : "coord"} />
