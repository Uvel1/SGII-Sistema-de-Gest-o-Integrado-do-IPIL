  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="flex flex-row items-center justify-center">
        <p
          className="text-nowrap text-ellipsis overflow-hidden w-28 cursor-pointer"
          onDoubleClick={() => {
            navigator.clipboard
              .writeText(row.original.aluno.email)
              .then(() => {
...
export function TableAdminPedidos() {
