...
import { PerfilProfessor } from "@/components/DropDown/perfilProfessor";
import { SidebarOpen, Home, Notebook, School } from "lucide-react";
...
export default function SideBar() {
  ...
  const links = [
    { href: "/professores", label: "Ínicio", icon: Home },
    { href: "/professores/turmas", label: "Turmas", icon: School },
    { href: "/professores/notas", label: "Notas", icon: Notebook },
  ];
