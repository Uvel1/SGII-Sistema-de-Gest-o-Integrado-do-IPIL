      ...
      <div className="grid min-h-svh lg:grid-cols-2">
        <div className="flex flex-col gap-4 p-6 md:p-10">
          <div className="flex justify-center gap-2 md:justify-start">
            <a href="#" className="flex items-center gap-2 font-bold text-blue-700">
        ...
        <div className="relative hidden lg:flex-col lg:items-center lg:justify-center bg-blue-900 text-white lg:flex lg:p-8">
    ...
    return (
      <form className={cn("flex flex-col gap-6", className)} {...props} onSubmit={handleSubmit}>
        <div className="flex flex-col items-center gap-2 text-center">
          <h1 className="text-2xl font-bold text-blue-700">Verificar Conta</h1>
          <p className="text-balance text-sm text-blue-700">
        ...
        <div className="grid gap-6">
          ...
          <Button type="submit" className="w-full font-bold bg-blue-700 hover:bg-blue-800">
            Verificar Conta
          </Button>
          <Button variant="outline" className="w-full text-blue-700 font-bold hover:text-blue-700 hover:bg-muted">
            Entrar 
          </Button>
        </div>
      </form>
