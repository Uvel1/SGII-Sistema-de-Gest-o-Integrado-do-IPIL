...
export default function AdminHomePage() {
  return (
    <>
      <div className="w-full p-2 pt-14 md:pt-0">
        <h2 className="text-2xl font-bold text-blue-700 flex flex-row space-x-2 items-center"><Home></Home><span>Ínicio</span></h2>
