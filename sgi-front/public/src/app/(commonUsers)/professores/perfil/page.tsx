    ...
    <>
      ...
      <div className="w-full p-8 pt-24">
        ...
        <div className="w-full flex flex-col items-center justify-center gap-4">
          ...
          <h3 className="text-blue-700 font-bold text-2xl">Lucas Pazito</h3>
          <div className="w-full h-auto md:w-[800px] h-16 border-2 border-blue-700 rounded-lg p-4 grid grid-cols-1 md:grid-cols-3 items-center justify-center">
            <div className="flex flex-col items-center justify-center w-full">
              <h2 className="font-bold text-blue-700">Disciplina</h2>
              <span className="text-blue-700">TLP</span>
            </div>
            <div className="flex flex-col items-center justify-center w-full">
              <h2 className="font-bold text-blue-700">Email</h2>
              <span className="text-blue-700 text-nowrap text-ellipsis overflow-hidden w-44">lucaspazito@gmail.com</span>
            </div>
            <div className="flex flex-col items-center justify-center w-full">
              <h2 className="font-bold text-blue-700">Cargo</h2>
              <span className="text-blue-700">Coordenador/a</span>
            </div>
          </div>
        </div>
      </div>
